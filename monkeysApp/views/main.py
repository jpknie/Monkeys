...
def index():
    ...
    return render_template('monkeys.html', page_title=page_title)
...
def monkey_add():
    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        return redirect(url_for('main_blueprint.monkey_add'))
    return render_template('monkey_form.html', form_action='/monkeys/add', form=form, page_title=page_title)
